...
机械动力火炮：机炮弹药革命 — 为 [Create Big Cannons](https://github.com/Cannoneers-of-Create/CreateBigCannons) 添加多种新型机炮弹药。

## Items / 物品

| 物品 | 类型 | 描述 |
|------|------|------|
| APFSDS Projectile | 弹头 | 动能穿甲弹，穿深40 |
| APHE Projectile | 弹头 | 穿甲高爆弹，穿深14 |
| SAP Projectile | 弹头 | 半穿甲弹，穿深12 |
| Shrapnel Projectile | 弹头 | 榴霰弹，40枚破片 |
| Thermite Projectile | 弹头 | 铝热剂弹头，方块挖掘+引燃 |
| Multi-Purpose Grenade | 弹头 | 多用途榴弹，小型破甲/爆炸 |
| Frag Grenade | 弹头 | 低速破片榴弹，8枚子母弹碰撞引爆 |
| Smoke/Potion Round | 弹头 | 烟雾/药水弹，可装载滞留药水 |
| Soul Fire Device | 工具 | 与弹药合成附加火焰爆炸+25%HP伤害 |
...
- 不可装备灵魂火装置
- 无药水模式：撞击产生烟雾云团（小规模）
- 药水模式：与滞留药水合成后，撞击产生药水云团（小规模）
- Shift可查看当前装载的药水效果

### 高速机炮弹药
- 初速为普通弹药2倍
- 支持弹头：APFSDS/APHE/SAP/Shrapnel/Thermite/MultiPurpose/Smoke

### 灵魂火装置
- 可附加到APHE/SAP/Shrapnel/Thermite/MultiPurpose弹药
- 爆炸时产生火焰 + 对3×3×3格内生物造成25%最大生命伤害
