...
| 物品 | 类型 | 描述 |
|------|------|------|
| APFSDS Projectile | 弹头 | 动能穿甲弹，穿深14 |
...
| Soul Fire Device | 工具 | 与弹药合成附加火焰爆炸+15%HP伤害 |
...
### 高速机炮弹药
- 初速为普通弹药2倍
- 支持所有弹头类型（APFSDS/APHE/SAP/Shrapnel/Thermite/MultiPurpose）

### 灵魂火装置
- 可附加到任何机炮弹药上
- 爆炸时产生火焰 + 对1格内生物造成15%最大生命伤害
